...
export const PROVIDER_PRESETS: Record<string, {
  ...
  'OpenCode Zen': {
    ...
    tags: ['免费'],
    models: ['mimo-v2-pro-free', 'mimo-v2-omni-free', 'nemotron-3-super-free', 'minimax-m2.5-free', 'ZhipuAI/GLM-5.1'],
  },
  Groq: {
    type: 'openai',
    ...
    tags: ['免费'],
    models: ['meta-llama/llama-4-scout-17b-16e-instruct', 'openai/gpt-oss-120b', 'qwen/qwen3-32b'],
  },
  SiliconFlow: {
    type: 'openai',
    baseUrl: 'https://api.siliconflow.cn/v1',
    apiKeyEnvVar: 'SILICONFLOW_API_KEY',
    defaultModel: 'Tram/Qwen3-Coder',
    tags: ['免费'],
  },
  Pollinations: {
    type: 'openai',
  ...
  Mistral: {
    ...
    models: ['devstral-latest', 'mistral-large-latest', 'codestral-latest'],
  },
  'ModelScope': {
    type: 'openai',
    ...
    models: ['MiniMax/MiniMax-M2.7', 'MiniMax/MiniMax-M2.5', 'moonshotai/Kimi-K2.5', 'Qwen/Qwen3.5-397B-A17B'],
  },
  'Zhipu': {
    type: 'openai',
...
/** Cloudflare AI Gateway 中转 URL 映射（支持所有列出的供应商） */
export const GATEWAY_URLS: Record<string, string> = {
  OpenAI: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/openai',
  'Google AI Studio': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/google-ai-studio',
  Anthropic: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/anthropic',
  Groq: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/groq/v1',
  Mistral: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/mistral/v1',
  'ModelScope': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/custom-modelscope/v1',
  'Zhipu': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/custom-bigmodel/v4',
  'OpenCode Zen': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/custom-opencode/v1',
  Cerebras: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/cerebras/v1',
  'Moonshot': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/custom-moonshot/v1',
  'DeepSeek': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/deepseek/v1',
  'Minimax-CN': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/custom-minimaxi/v1',
  'Minimax-GB': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/custom-minimax/v1',
  SiliconFlow: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/openai',
  Pollinations: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/openai',
  DashScope: 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/openai',
  'OpenRouter': 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/openai',
};

/** 检查某个供应商是否支持 Gateway 中转 */
export function supportsGateway(providerName: string): boolean {
  return true; // 支持所有
}

/** 获取供应商的 Gateway URL */
export function getGatewayUrl(providerName: string): string | undefined {
  return GATEWAY_URLS[providerName] || 'https://gateway.ai.cloudflare.com/v1/1d3c896c3b5b4bbc027c4b8369f0d734/tram-ai/openai';
}
